...
namespace HaikangSDK
{
	...
	/// CHCNetSDK 的摘要说明。
	/// </summary>
    public class CHCNetSDK_Linux
    {
        public CHCNetSDK_Linux()
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        **********************************************************/
        ...
        [DllImport(@"libhcnetsdk.so")]
        public static extern bool NET_DVR_SetDVRMessageCallBack_V31(CHCNetSDK_Linux.MSGCallBack_V31 fMessageCallBack, IntPtr pUser);
        ...
        [DllImport(@"libhcnetsdk.so")]
        public static extern int NET_DVR_StartListen_V30(String sLocalIP, ushort wLocalPort, CHCNetSDK_Linux.MSGCallBack DataCallback, IntPtr pUserData);
        ...
        **********************************************************/
        ...
        [DllImportAttribute(@"libhcnetsdk.so")]
