...
namespace HaikangSDK
{
	...
	/// CHCNetSDK 的摘要说明。
	/// </summary>
    public class CHCNetSDK_Win64
    {
        public CHCNetSDK_Win64()
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        **********************************************************/
        ...
        [DllImport(@"HCNetSDK.dll")]
        public static extern int NET_DVR_StartListen_V30(String sLocalIP, ushort wLocalPort, CHCNetSDK_Win64.MSGCallBack DataCallback, IntPtr pUserData);
        ...
        ******************************************************************************/
        ...
        [DllImport(@"HCNetSDK.dll")]
        public static extern bool NET_DVR_FOCUSMODE_CFG(uint dwSize, byte byFocusMode, byte byAutoFocusMode, ushort wMinFocusDistance, byte byZoomSpeedLevel, byte byFocusSpeedLevel, byte byOpticalZoom, byte byDigtitalZoom,
        float fOpticalZoomLevel,
        uint dwFocusPos,
        byte byFocusDefinitionDisplay,
        byte byFocusSensitivity,
        byte[] byRes1,
        uint dwRelativeFocusPos,
        byte[] byRes);
    }
}
